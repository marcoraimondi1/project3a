...
def get_chart_data():
    try:
        ...
        # Get your API key from environment or use 'demo' (limited)
        ...
        if stock_data is None:
            return jsonify({'error': 'Failed to retrieve stock data. Please check your API key and date range.'}), 400
